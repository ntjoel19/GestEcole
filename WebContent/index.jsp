...
<html>
    ...
    <head>
        ...
        <title>Gestion des note-connection</title>
                    ...
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2 text">
                            ...
                            <div class="description">
                            	<p>
	                            	Se connecter donne accès à l'interface de gestion des notes.
                            	</p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-sm-5">
                        	...
                        	<div class="form-box">
	                            ...
	                            <div class="form-bottom">
				                    <form role="form" action="/GestEcole/connexion" method="post" class="login-form">
